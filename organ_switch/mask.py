...
Mouth = [18, 43, 57, 83, 92, 106, 164, 165, 167, 182, 186, 273, 287, 313, 322, 335, 391, 393, 406, 410]

align = (left_brow + right_eye + left_eye + right_brow + nose + mouth)
align_mp = (LeftEye + RightEye + Mouth + Nose)
    ...
    with mp_face_mesh.FaceMesh(
        ...
        min_detection_confidence=0.5) as face_mesh:
            ...
            for num in range(468):
                ...
                points.append(point)
            pts = np.matrix([[p[0], p[1]] for p in points])
